# REZOOMIX - An AI Resume Analyzer
...
An AI-powered Resume Analyzer with React, React Router, and Puter.js, implemented with features such as seamless auth, upload and store resumes, and match candidates to jobs using smart AI evaluations. Get custom feedback and ATS scores tailored to each listing—all wrapped in a clean, reusable UI.
...
```bash
git clone https://github.com/prachit082/Resume-Analyzer.git
cd Resume-Analyzer
```
